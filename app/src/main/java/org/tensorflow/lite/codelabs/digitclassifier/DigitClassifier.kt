...
class DigitClassifier(private val context: Context) {
  ...
  private fun classify(bitmap: Bitmap): String {
    ...
    var byteBuffer = convertBitmapToByteBuffer(resizedImage)

    // Define an array to store the model output.
    var output = Array(1) { FloatArray(OUTPUT_CLASSES_COUNT) }
    ...
    var result = output[0]
    var maxIndex = result.indices.maxBy { result[it] } ?: -1
    var resultString =
      "Prediction Result: %d\nConfidence: %2f"
